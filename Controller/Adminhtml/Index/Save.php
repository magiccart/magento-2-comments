 ...
 * @@Modify Date: 2018-07-17 17:05:56
 * @@Function:
 */
...
class Save extends \Magiccart\Comments\Controller\Adminhtml\Action
{
    /**
        ...
        if ($data = $this->getRequest()->getPostValue()) {
            ...
            if (isset($_FILES['image']) && isset($_FILES['image']['name']) && strlen($_FILES['image']['name'])) {
                ...
                try {
                    ...
                    $uploader->addValidateCallback('comments_image', $imageAdapter, 'validateUploadFile');
                    ...
                    $result = $uploader->save(
                        $mediaDirectory->getAbsolutePath('magiccart/comments/')
                    );
                    $data['image'] = 'magiccart/comments/'.$result['file'];
                } catch (\Exception $e) {
                    if ($e->getCode() == 0) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('The Comments menu has been saved.'));
                ...
                $this->messageManager->addError($e->getMessage());
                $this->messageManager->addException($e, __('Something went wrong while saving the comments.'));
            }
